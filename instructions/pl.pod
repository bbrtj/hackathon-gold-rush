...
Zaleca się wykonywanie rozkazów sychronicznie poprzez czekanie na odpowiedź
przed wykonaniem nowego rozkazu. Odpowiedzi na rozkazy nie zawierają
identyfikatorów, więc nie da się inaczej określić na który rozkaz odpowiadają.
